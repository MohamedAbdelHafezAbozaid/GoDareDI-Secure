...
# Create All Apple Platforms XCFramework for GoDareDI
# Supports iOS, iPadOS, tvOS, watchOS, macOS

set -e

echo "🔐 Creating All Apple Platforms XCFramework..."
...
build_framework() {
    ...
    case $platform in
        ...
        "macos-x86_64")
            ...
            ;;
        "macos-arm64")
            sed 's/PLATFORM_VERSION/11.0/g; s/PLATFORM_NAME/MacOSX/g' TempFramework/Info.plist.template > Frameworks/$platform/GoDareDI.framework/Info.plist
            ;;
    esac
...
build_framework "macos-x86_64" "x86_64-apple-macos10.15" "macosx" "10.15" "x86_64"

# macOS - arm64 (Apple Silicon Macs)
build_framework "macos-arm64" "arm64-apple-macos11.0" "macosx" "11.0" "arm64"

# Step 6: Create XCFramework
echo "🎯 Step 6: Creating All-Platform XCFramework..."
...
echo "✅ All Apple Platforms XCFramework Created Successfully!"
